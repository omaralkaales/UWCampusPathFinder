...
public class Path<E> implements Iterable<Path<E>.Segment> {
  ...
  /**
   * The starting object at the beginning of this path.
   */
  private E start;

  /**
   * The ordered sequence of segments representing a path between two objects.
   */
  private List<Path<E>.Segment> path;
   ...
   * are created as part of larger paths by calling {@link Path#extend(Object, double)}.
   */
